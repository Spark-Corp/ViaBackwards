package com.viaversion.viabackwards.updater;
...
public class AutoUpdater {
    ...
    public boolean verify() {
        ...
        System.out.println("Searching for Via Backwards updates...");

        if (hasUpdate()) {
            System.out.println("Via Backwards update found!");
            update();
            return true;
        } else {
            System.out.println("No Via Backwards updates found!");
        }
